...
function tplot_ut::test_mms_tplot2cdf_basic
  ...
  tplot2cdf2, filename='test_feeps_intensity_omni.cdf', tvars=['mms1_epd_feeps_srvy_l2_electron_intensity_omni', 'mms1_epd_feeps_srvy_l2_electron_intensity_omni_spin'], /default
