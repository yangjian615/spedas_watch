...
; Save cdf file with default (undefined) attributes
tplot2cdf2, filename='mHz_wave_default', tvars='mHz_sin_wave', /default
stop

;
; Now we add some attributes to the tplot vatiable
; 
...
; Create CDF structure with default (undefined) attributes of the tplot variables
...
; Now we can retrieve the attributes structure that is stored in "attrptr" pointer
...
print, "Default (undefined) attributes of the data:"
...
; Save cdf file with new attributes
...
; Let's define the attibuted of the time variable. The CDF structure was already retiven from 'mHz_sin_wave' tplot variable
...
; Since 'mHz_sin_wave' goes first in the list of tvars, the attributes of the Epoch will be taken from CDF structure of 'mHz_sin_wave'  
