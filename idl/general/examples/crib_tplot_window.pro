...
;
;
; SEE ALSO: crib_tplot (basic tplot crib)
...
;
; NOTES:
;   This is identical to crib_tplot.pro, except for a tplot_window
;   command at the start, replacing tplot.
;
; $LastChangedBy: jimm $
; $LastChangedDate: 2016-10-04 14:20:01 -0700 (Tue, 04 Oct 2016) $
; $LastChangedRevision: 22021 $
...
;use 'tplot_window' to plot some moments line data
tplot_window,'sta_SWEA_mom_flux'


print,"Used 'tplot_window,name' plot line data."
...
print,"      't' for interactive tlimit, which allows you to set "
print,"          the plotted time range by clicking same as in a regular window;"
