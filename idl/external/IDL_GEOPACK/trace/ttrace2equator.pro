...
; $LastChangedDate: 2014-03-04 09:40:56 -0800 (Tue, 04 Mar 2014) $
; $LastChangedRevision: 14486 $
...
pro ttrace2equator,in_pos_tvar,newname = newname, trace_var_name = trace_tvar, in_coord = in_coord, $
    ...
    get_tilt=get_tilt,set_tilt=set_tilt,add_tilt=add_tilt,get_nperiod=get_nperiod
