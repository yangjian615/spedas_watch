...
function t01, tarray, rgsm_array,pdyn,dsti,yimf,zimf,g1,g2, period = period,add_tilt=add_tilt,get_tilt=get_tilt,set_tilt=set_tilt,get_nperiod=get_nperiod,get_period_times=get_period_times,storm=storm
