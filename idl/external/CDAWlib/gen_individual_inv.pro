...
if (datasets[0] ne '') then a = ingest_database('/home/cdaweb/metadata/lunar_cdfmetafile.txt',DATASETS=datasets)
...
if (datasets[0] ne '') then a = ingest_database('/home/cdaweb/metadata/istp_public_cdfmetafile.txt',DATASETS=datasets)
; Draw inventory graph...
...
; Read the metadata file...
datasets = get_datasets('AMPTE', '/home/cdaweb/metadata/istp_public_cdfmetafile.txt')
...
; Read the metadata file...
ds_list = ['RBSP']
datasets = get_datasets(ds_list, '/home/cdaweb/metadata/test_rbsp_j_cdfmetafile.txt')
if (datasets[0] ne '') then print,'Generating RBSP'
if (datasets[0] ne '') then a = ingest_database('/home/cdaweb/metadata/test_rbsp_j_cdfmetafile.txt',DATASETS=datasets)
; Draw inventory graph...
