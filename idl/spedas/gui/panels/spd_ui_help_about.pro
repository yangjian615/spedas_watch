...
Pro spd_ui_help_about, gui_id, historywin
  ...
  aboutString= ' SPEDAS 1.0 '  +  string(10B) + string(10B) + ' Space Physics Environment Data Analysis Software ' +  string(10B) + string(10B) + ' February 2014 ' + string(10B) + string(10B) + string(10B) + string(10B) +' For support or bug reports, contact: SPEDAS_Science_Support@ssl.berkeley.edu '
