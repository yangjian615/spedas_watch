...
;$LastChangedDate: 2014-09-25 14:53:34 -0700 (Thu, 25 Sep 2014) $
;$LastChangedRevision: 15865 $
;$URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/spdsoft/trunk/projects/poes/spedas_plugin/spd_ui_load_poes_data.pro $
;
;--------------------------------------------------------------------------------
pro spd_ui_load_poes_data_event,event
    ...
    case uval of
      ...
      'ADD': begin
        ...
        callSeqStruc = { type:'loadapidata',       $
                         subtype:'spd_ui_load_poes_import',  $
                         loadStruc:loadStruc,     $
                         overwrite_selections:overwrite_selections }
...
pro spd_ui_load_poes_data,tabid,loadedData,historyWin,statusBar,treeCopyPtr,timeRangeObj,callSequence,loadTree=loadTree,timeWidget=timeWidget
  ...
  topBase = Widget_Base(tabid, /Row, /Align_Top, /Align_Left, YPad=1,event_pro='spd_ui_load_poes_data_event') 
