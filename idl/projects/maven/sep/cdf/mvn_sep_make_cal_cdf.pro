...
mvn_sep_cdf_var_att_create,fileid,varname,data_vary.A_XRAY_RATE,attributes=atts
...
mvn_sep_cdf_var_att_create,fileid,varname,data_vary.B_XRAY_RATE,attributes=atts
...
if 0 && keyword_set(data_novary) then begin
  atts=default_atts
  bmap = data_novary
