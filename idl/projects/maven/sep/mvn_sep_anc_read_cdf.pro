...
; note that SSO coordinates are only useful or relevant for cruise phase data (2013-11-18 to 2014-09-21)
  ...
  tmp.FOV_sun_angle = transpose ([[*cdfi.vars[20].dataptr], [*cdfi.vars[21].dataptr],[*cdfi.vars[22].dataptr],[*cdfi.vars[23].dataptr]])
  tmp.FOV_ram_angle = transpose ([[*cdfi.vars[24].dataptr], [*cdfi.vars[25].dataptr],[*cdfi.vars[26].dataptr],[*cdfi.vars[27].dataptr]])
  tmp.FOV_pitch_angle = transpose ([[*cdfi.vars[28].dataptr], [*cdfi.vars[29].dataptr],[*cdfi.vars[30].dataptr],[*cdfi.vars[31].dataptr]])
  tmp.fraction_FOV_Mars = transpose ([[*cdfi.vars[32].dataptr], [*cdfi.vars[33].dataptr],[*cdfi.vars[34].dataptr],[*cdfi.vars[35].dataptr]])
  tmp.fraction_FOV_illuminated = transpose ([[*cdfi.vars[32].dataptr], [*cdfi.vars[33].dataptr],[*cdfi.vars[34].dataptr],[*cdfi.vars[36].dataptr]])
  tmp.Mars_fraction_sky = *cdfi.vars[36].dataptr
  tmp.qrot_SEP1_to_MSO = transpose (*cdfi.vars[41].dataptr)
  tmp.qrot_SEP2_to_MSO = transpose (*cdfi.vars[42].dataptr)
  tmp.qrot_SEP1_to_SSO = transpose (*cdfi.vars[43].dataptr)
  tmp.qrot_SEP2_to_SSO = transpose (*cdfi.vars[44].dataptr)
  tmp.qrot_SEP1_to_GEO = transpose (*cdfi.vars[45].dataptr)
  tmp.qrot_SEP2_to_GEO = transpose (*cdfi.vars[46].dataptr)
  tmp.mvn_pos_MSO = transpose (*cdfi.vars[47].dataptr)
  tmp.mvn_pos_GEO = transpose (*cdfi.vars[48].dataptr)
  tmp.mvn_pos_ECLIPJ2000 = transpose (*cdfi.vars[49].dataptr)
  tmp.Earth_pos_ECLIPJ2000 = transpose (*cdfi.vars[50].dataptr)
  tmp.Mars_pos_ECLIPJ2000 = transpose (*cdfi.vars[51].dataptr)
  tmp.mvn_lat_GEO=*cdfi.vars[52].dataptr
  tmp.mvn_elon_GEO=*cdfi.vars[53].dataptr
  tmp.mvn_alt_areoid = mvn_get_altitude(reform (tmp.mvn_pos_GEO[0,*]),$
                                                  reform (tmp.mvn_pos_GEO[1,*]),$
    reform (tmp.mvn_pos_GEO[2,*]))
  tmp.mvn_sza=*cdfi.vars[54].dataptr
  tmp.mvn_slt=*cdfi.vars[55].dataptr
