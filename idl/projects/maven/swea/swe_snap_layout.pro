...
; $LastChangedDate: 2014-05-13 20:48:53 -0700 (Tue, 13 May 2014) $
; $LastChangedRevision: 15128 $
...
pro swe_snap_layout, layout
  ...
  case layout[0] of
    ...
    1    : begin  ; Macbook 1440x900 with Dell 1920x1200 (above)
             ...
             Eopt = {xsize:400, ysize:600, xpos:780,  ypos:-600}  ; SPEC
             Hopt = {xsize:225, ysize:545, xpos:1200, ypos:-600}
           end
