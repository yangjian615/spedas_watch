...
; $LastChangedDate: 2017-06-12 16:57:10 -0700 (Mon, 12 Jun 2017) $
; $LastChangedRevision: 23456 $
...
; Case folded minimum matching for the remainder of the fragment
  ...
  flist = ['MARS','PHOBOS','DEIMOS','SPACECRAFT','APP','STATIC',$
           'SWIA','SWEA','MAG1','MAG2','EUV','SEP1','SEP2',$
           'IUVS_LIMB','IUVS_NADIR','NGIMS']
