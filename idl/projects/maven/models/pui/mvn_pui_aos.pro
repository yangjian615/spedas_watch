...
if keyword_set(swim) then swi={swim:swim[0],swis:swis[0],swica:swica[0],swics:swics[0],swim2:swim2} else swi={swim:{density:fnan,velocity_mso:replicate(fnan,3)},swim2:swim2}
