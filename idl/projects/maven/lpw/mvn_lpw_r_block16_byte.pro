...
;
;USAGE:
;  mvn_lpw_pkt_r_block16_byte,data,ptr,nn_e,mask8,bin_c,index_arr,arr_size,edac_on
;
;INPUTS:
...
;FILE: mvn_lpw_pkt_r_block16_byte.pro
;VERSION:   1.1
...
function mvn_lpw_r_block16_byte, data, ptr, nn_e, mask8, bin_c, index_arr, arr_size, edac_on
   ...
   tmp_a=intarr(8) 
   ptr_size=(20+9+20*15)/8  < ((n_elements(data)-ptr)-1)  ; the maxumum size length in bytes to request data from and not longer than the data array
