...
;$URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/spdsoft/trunk/projects/maven/spedas_plugin/mvn_kp_ui_load_data.pro $
;
;--------------------------------------------------------------------------------

pro mvn_kp_ui_load_data_event,event
...
pro mvn_kp_ui_load_data,tabid,loadedData,historyWin,statusBar,treeCopyPtr,timeRangeObj,$
  ...
  topBase = Widget_Base(tabid, /Row, /Align_Top, /Align_Left, YPad=1,event_pro='mvn_kp_ui_load_data_event') 
