...
function spp_swp_spani_targ_p3_m1_decom,ccsds,ptp_header=ptp_header,apdat=apdat
...
pro spp_swp_spani_targ_p3_m1_init

  spp_apid_data,'394'x ,$
                routine='spp_swp_spani_targ_p3_m1_decom',$
                tname='spp_swp_spani_targ_p3_m1_',$
                tfields='*',$
                rt_tags='*', $
                save=save,$
                rt_flag=rt_flag
