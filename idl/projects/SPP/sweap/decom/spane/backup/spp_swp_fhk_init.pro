...
;pro spp_swp_spane_fast_hkp_init
;
;  spp_apid_data,'36F'x,routine='spp_swp_spane_fast_hkp_decom',tname='spp_fast_hkp_',tfields='*',name='SWEAP SPAN-I FHK',rt_tags='*',save=1
;
;end
