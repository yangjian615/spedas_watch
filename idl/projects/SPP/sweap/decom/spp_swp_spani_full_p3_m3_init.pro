...
function spp_swp_spani_full_p3_m3_decom,ccsds,ptp_header=ptp_header,apdat=apdat
...
pro spp_swp_spani_full_p3_m3_init

  spp_apid_data,'38a'x ,$
                routine='spp_swp_spani_full_p3_m3_decom',$
                tname='spp_swp_spani_full_p3_m3_',$
                tfields='*',$
                rt_tags='*', $
                save=save,$
                rt_flag=rt_flag
