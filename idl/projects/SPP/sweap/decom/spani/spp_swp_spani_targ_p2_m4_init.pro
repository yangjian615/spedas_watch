...
function spp_swp_spani_targ_p2_m4_decom,ccsds,ptp_header=ptp_header,apdat=apdat
...
pro spp_swp_spani_targ_p2_m4_init

  spp_apid_data,'393'x ,$
                routine='spp_swp_spani_targ_p2_m4_decom',$
                tname='spp_swp_spani_targ_p2_m4_',$
                tfields='*',$
                rt_tags='*', $
                save=save,$
                rt_flag=rt_flag
