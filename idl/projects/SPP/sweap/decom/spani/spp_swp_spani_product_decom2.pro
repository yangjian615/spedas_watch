...
function spp_swp_spani_16Ax8Dx32E, data, header_str=header_str, apdat=apdat   ; this function needs fixing
...
if  ns gt 0 then begin
  ...
  case ndat  of
    ...
    512:  res = spp_swp_spani_16Ax32E(data, header_str=str, apdat=apdat)
    4096: res = spp_swp_spani_16Ax8Dx32E(data, header_str=str, apdat=apdat)
