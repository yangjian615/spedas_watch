...
function spp_swp_spani_targ_p3_m2_decom,ccsds,ptp_header=ptp_header,apdat=apdat
...
pro spp_swp_spani_targ_p3_m2_init

  spp_apid_data,'395'x ,$
                routine='spp_swp_spani_targ_p3_m2_decom',$
                tname='spp_swp_spani_targ_p3_m2_',$
                tfields='*',$
                rt_tags='*', $
                save=save,$
                rt_flag=rt_flag
