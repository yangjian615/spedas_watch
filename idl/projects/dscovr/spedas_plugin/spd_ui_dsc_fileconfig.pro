...
;      !dsc.no_download = state.def_values[0]
;      !dsc.no_update = state.def_values[1]      
;      !dsc.downloadonly = state.def_values[2]
;      !dsc.verbose = state.def_values[3]
...
;Next radio buttions
  ...
  state = {localdir:localdir, remotedir:remotedir, plotsdir:plotsdir, $
