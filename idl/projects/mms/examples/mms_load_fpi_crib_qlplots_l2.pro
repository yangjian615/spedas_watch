...
FOR i=1,n_elements(probes) DO BEGIN    ;step through the observatories
   ...
   ; eph_variable = 'mms'+strcompress(string(i), /rem)+'_defeph_pos'
    ...
    store_data, obsstr+'eBulkV_mag_DSC'+'_dbcs_'+data_rate, data = {x:xtimes, y:e_bulk_mag}
   ;join_vec, [obsstr+'des_bulkX', obsstr+'des_bulkY', obsstr+'des_bulkZ', obsstr+'eBulkV_mag_DSC'], obsstr+'eBulkV_DSC'
    join_vec, [obsstr+'des_bulkx', obsstr+'des_bulky', obsstr+'des_bulkz', obsstr+'eBulkV_mag_DSC']+'_dbcs_'+data_rate, obsstr+'eBulkV_DSC'
    ...
    options, obsstr+'eBulkV_DSC', 'ytitle', 'MMS'+STRING(i,FORMAT='(I1)')+'!CeBulkV!CDBCS'
    ...
    store_data, obsstr+'iBulkV_mag_DSC'+'_dbcs_'+data_rate, data = {x:xtimes, y:i_bulk_mag}
   ; join_vec, [obsstr+'dis_bulkX', obsstr+'dis_bulkY', obsstr+'dis_bulkZ', obsstr+'iBulkV_mag_DSC'], obsstr+'iBulkV_DSC'
    join_vec, [obsstr+'dis_bulkx', obsstr+'dis_bulky', obsstr+'dis_bulkz', obsstr+'iBulkV_mag_DSC']+'_dbcs_'+data_rate, obsstr+'iBulkV_DSC'
    ...
    options, obsstr+'iBulkV_DSC', 'ytitle', 'MMS'+STRING(i,FORMAT='(I1)')+'!CiBulkV!CDBCS'
...
;    tplot_options,'title', window_caption
   ...
   ; fpi_espects = [obsstr+'dis_EnergySpectr_omni_avg', obsstr+'des_EnergySpectr_omni_avg']
    fpi_moments = [prefix+'_dfg_dmpa_srvy_clipped', [obsstr+'des_numberdensity', obsstr+'dis_numberdensity']+'_dbcs_'+data_rate, obsstr+'eBulkV_DSC',  $
                   obsstr+'iBulkV_DSC', obsstr+'temp']
    fpi_espects = [obsstr+'dis_EnergySpectr_omni_avg', obsstr+'des_EnergySpectr_omni_avg']
    panels=['mms_bss_burst', 'mms_bss_fast', qual_bar, $
