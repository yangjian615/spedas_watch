...
;
;-
pro mms_pgs_shift_phi_spec_pad, data, yrange
...
;$URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/spdsoft/trunk/projects/mms/spedas/beta/mms_part_products/mms_pgs_shift_phi_spec.pro $
;-

pro mms_pgs_shift_phi_spec, names=names_in, start_angle=start_angle
  ...
  for i=0, n_elements(names)-1 do begin
    ...
    mms_pgs_shift_phi_spec_pad, data, yrange
