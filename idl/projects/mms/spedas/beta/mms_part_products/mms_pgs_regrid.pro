...
;$URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/spdsoft/trunk/projects/mms/spedas/beta/mms_part_products/mms_pgs_regrid.pro $
;-


pro mms_pgs_regrid,data,regrid_dimen,output=output,error=error
...
;  end
 ...
 ;copied from mms_pgs_clean_fpi.pro
