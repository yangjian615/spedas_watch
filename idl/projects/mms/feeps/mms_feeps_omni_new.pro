...
; $LastChangedDate: 2017-01-26 16:00:35 -0800 (Thu, 26 Jan 2017) $
; $LastChangedRevision: 22676 $
; $URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/spdsoft/trunk/projects/mms/feeps/mms_feeps_omni_new.pro $
;-


pro mms_feeps_omni_new, probe, datatype = datatype, tplotnames = tplotnames, suffix = suffix, $
  ...
  store_data, newname, data={x: d.x, y: en_flux_out, v: en_label}
