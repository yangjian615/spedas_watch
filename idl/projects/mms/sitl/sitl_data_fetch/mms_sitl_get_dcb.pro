...
;  $LastChangedDate: 2015-04-14 14:15:11 -0700 (Tue, 14 Apr 2015) $
;  $LastChangedRevision: 17317 $
...
if keyword_set(no_update) then begin
  mms_data_fetch, local_flist2, start_date, end_date, login_flag, sc_id=sc_id(j), $
