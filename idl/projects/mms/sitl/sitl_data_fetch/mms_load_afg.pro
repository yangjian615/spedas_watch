...
; KEYWORDS:
;
;   sc               - OPTIONAL. (String) Array of strings containing spacecraft
...
;  $LastChangedDate: 2015-05-27 10:12:26 -0700 (Wed, 27 May 2015) $
;  $LastChangedRevision: 17738 $
;  $URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/spdsoft/trunk/projects/mms/sitl/sitl_data_fetch/mms_load_afg.pro $





pro mms_load_afg, sc=sc, no_update = no_update, reload = reload
