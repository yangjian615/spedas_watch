...
if count_seg_error gt 0 then begin
  ...
  create_time_strings, new_backstr.start(loc_seg_error), seg_error_times
endif else begin
  seg_error_times = ''
endelse
...
if count_start_error gt 0 then begin
  ...
  create_time_strings, new_backstr.start(loc_start_error), start_error_times
endif else begin
  start_error_times = ''
endelse
...
if count_seg_warning gt 0 then begin
  ...
  create_time_strings, new_backstr.start(loc_seg_warning), seg_warning_times
endif else begin
  seg_warning_times = ''
endelse
...
if count_high_warning gt 0 then begin
  ...
  create_time_strings, new_backstr.start(loc_high_warning), high_warning_times
endif else begin
  high_warning_times = ''
endelse
...
if count_fom_approve gt 0 then begin
  ...
  create_time_strings, new_backstr.start(loc_fom_approve), fom_appr_times
endif else begin
  fom_appr_times = ''
endelse
