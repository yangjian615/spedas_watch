...
;$LastChangedDate: 2015-12-16 08:30:30 -0800 (Wed, 16 Dec 2015) $
;$LastChangedRevision: 19634 $
...
pro mms_eis_pad_spinavg, probe=probe, species = species, data_units = data_units, $
    ...
    pad_name = prefix + en_range_string + '_' + species + '_' + data_units + '_pad'
    ...
    new_bins = 180.*indgen(n_pabins)/n_pabins
