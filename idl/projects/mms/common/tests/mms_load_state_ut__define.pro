...
; $LastChangedDate: 2017-08-11 09:06:41 -0700 (Fri, 11 Aug 2017) $
; $LastChangedRevision: 23774 $
...
function mms_load_state_ut::test_orbit_plots
    ...
    orbitplot = spd_download(remote_file = 'http://themis.ssl.berkeley.edu/themisdata/thg/l0/asi/'+time_string(systime(1)-2*86400., tformat='YYYY/MM')+'/orbit_plusrbsp_plusmms_'+time_string(systime(1)-2*86400., tformat='YYYY-MM-DD')+'_0024.gif')
