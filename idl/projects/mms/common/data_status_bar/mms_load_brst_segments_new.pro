...
;$LastChangedDate: 2016-06-29 15:51:36 -0700 (Wed, 29 Jun 2016) $
;$LastChangedRevision: 21403 $
;$URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/spdsoft/trunk/projects/mms/common/data_status_bar/mms_load_brst_segments_new.pro $
;-

pro mms_load_brst_segments_new, trange=trange, suffix=suffix
  ...
  if is_struct(brst_intervals) then begin
    ...
    if t_count ne 0 then begin
      ...
      store_data,'mms_bss_brst'+suffix,data={x:bar_x, y:bar_y}
      options,'mms_bss_brst'+suffix,thick=5,xstyle=4,ystyle=4,yrange=[-0.001,0.001],ytitle='',$
