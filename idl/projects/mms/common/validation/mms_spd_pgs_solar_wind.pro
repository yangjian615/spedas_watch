...
; $LastChangedDate: 2018-01-25 16:27:22 -0800 (Thu, 25 Jan 2018) $
; $LastChangedRevision: 24594 $
...
for sw_i=0, n_elements(sw_intervals[0, *])-1 do begin
  ...
  moka_mms_part_products, 'mms'+probe+'_d'+species+'s_dist_brst', mag_name='mms'+probe+'_fgm_b_dmpa_srvy_l2_bvec', out=['pad'], vel_name='mms'+probe+'_d'+species+'s_bulkv_dbcs_brst', subtract_bulk=SUBTRACT_BULK
