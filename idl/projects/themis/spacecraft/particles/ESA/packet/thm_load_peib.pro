...
pro thm_load_peib,file=file,sc=sc,themishome=themishome, $
...
;			printdat,fs
	...
	dprint, dlevel=4, '456 Download time= ',tm2-tm1
...
endwhile
	...
	tm2=systime(1)
	dprint, dlevel=4, '456 Decommutation time=',tm2-tm1
...
thm_part_trange, sc, 'peib', set={trange:timerange(trange),eclipse:eclipse}


; help,ibd_dat,/st
dprint, dlevel=4, 'Data loading complete: th'+sc+' peib - apid 456'
