...
; $LastChangedDate: 2017-02-21 08:39:38 -0800 (Tue, 21 Feb 2017) $
; $LastChangedRevision: 22827 $
...
pro thm_load_gmag_networks, gmag_networks=gmag_networks, gmag_stations=gmag_stations, selected_network=selected_network
  ...
  if result eq 1 then begin
    ...
    gmag_stations=['abk','akul','amd','amer','amk','and','arct','atha','atu','benn','bett','bfe','bjn','blc','bmls','bou','brw','bsl','cbb','ccnv','cdrt','chbg', $
      ...
      'larg','lcl','leth','loys', 'lrel', 'lres','lrg','lrv','lyfd','lyr','mcgr','mas','mea','mek','muo','nain','nal','naq','new','nor','nrd','nrsq','nur','ott','ouj','pang','pbk', 'pblo','pcel','pel','pg0','pg1','pg2','pg3', $
